...
RenderObjectFactoryObjPtr
RenderObjectFactoryObj::Create() {
  return std::make_shared< Alloc<RenderObjectFactoryObj, RenderObjectFactoryObj::State> >();
}

RenderObjectFactoryObj::RenderObjectFactoryObj() : m(nullptr) {}
